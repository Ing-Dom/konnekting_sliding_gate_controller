...
int DRIVECURRENT_ZERO = 509;
int DRIVECURRENT_JIT = 5;
int DRIVECURRENT_NUM = 3;
...
int in_current_smoothed = DRIVECURRENT_ZERO;
int in_currents[50];
...
int zero_current_value = DRIVECURRENT_ZERO;
...
void setup()
{
    ...
    {
        zero_current_value = (int)(Konnekting.getUINT16Param(PARAM_DRIVECURRENT_ZERO));
        DRIVECURRENT_JIT = (int)(Konnekting.getUINT16Param(PARAM_DRIVECURRENT_JIT));
        DRIVECURRENT_NUM = (int)(Konnekting.getUINT16Param(PARAM_DRIVECURRENT_NUM));
    }
