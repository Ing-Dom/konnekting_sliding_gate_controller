/* Changelog 06:
- changed order of firstrunT4 in T4() (Barrier first)
- made send_status_cyclic_cnt signed and changed -1 to +1 on other side
- setup_gpio added ! at digital read for low active logic
*/
